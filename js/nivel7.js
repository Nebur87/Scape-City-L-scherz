...
function initNivel7() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Habilitar el botón de captura cuando OpenCV.js esté disponible
    if (captureBtn && validationMsg) {
      validationMsg.innerText = 'Cargando OpenCV.js...';
    ...
    // Control de opacidad de la silueta
    const siluetaOpacity = document.getElementById('silueta-opacity');
    if (siluetaOpacity && silueta) {
      siluetaOpacity.addEventListener('input', function(e) {
        silueta.style.opacity = e.target.value;
      });
    }
